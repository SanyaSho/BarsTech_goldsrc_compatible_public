...
public:
	...
	//
	// return value - returns the number of bytes written to pBlob. If the return is 0, then the rgba passed in was too small, and the call has failed
	...
	// In that case, nBytesWritten is set to the size of the rgba required to decompress the given
	// data. The suggested rgba size for the destination rgba is 22 kilobytes.
