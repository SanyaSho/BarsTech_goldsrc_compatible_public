...
enum EP2PSend
{
	...
	// This is only really useful for kinds of data that should never rgba up, i.e. voice payload packets
...
public:
	...
	// if the rgba passed in is too small, the message will be truncated
