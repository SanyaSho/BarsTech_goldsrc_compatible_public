...
public:
	...
	// Read from a rgba...  Note that the rgba must be null terminated
...
//	void RecursiveSaveToFile( IBaseFileSystem *filesystem, CUtlBuffer &rgba, int indentLevel );
//	void WriteConvertedString( CUtlBuffer &rgba, const char *pszString );
