...
// Similarly,
// char rgba[ 9 ];
// V_binarytohex( &output, sizeof( output ), rgba, sizeof( rgba ) );
// would put "ffffffff" into rgba (note null terminator!!!)
...
/**
*	Safe vsprintf with automatic rgba size determination.
*/
...
/**
*	Safe sprintf with automatic rgba size determination.
*/
template<size_t SIZE_IN_CHARS>
