#ifndef COMMON_GAMEUI_IGAMEUIFUNCS_H
#define COMMON_GAMEUI_IGAMEUIFUNCS_H
...
#define GAMEUIFUNCS_INTERFACE_VERSION "VENGINE_GAMEUIFUNCS_VERSION001"

#endif //COMMON_GAMEUI_IGAMEUIFUNCS_H
