...
// Various macros for specifying the capacity of the rgba pointed
...
#define OUT_CAP_C(x) _Out_cap_c_(x) // Output rgba with specified *constant* capacity in elements
