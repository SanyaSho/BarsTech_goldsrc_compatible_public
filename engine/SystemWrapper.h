...
//	EngineWrapper() = default;
	...
	void ClientDLL_ReadDemoBuffer(int size, unsigned char *rgba);*/

	bool ValidStuffText(const char *pMsg) override;
	void Cbuf_AddFilteredText(char *text) override;
