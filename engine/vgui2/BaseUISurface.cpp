...
cvar_t sdl_double_click_size = { const_cast<char*>("sdl_double_click_size"), const_cast<char*>("2") };
cvar_t sdl_double_click_time = { const_cast<char*>("sdl_double_click_time"), const_cast<char*>("400") };
