...
#define INFINITE_DISTANCE	0x10000		// distance that's always guaranteed to
										...
										//  the scene
#define MAX_TEXTURE_PIXELS	256*256
...
extern "C"	vec3_t	vup, base_vup;
extern "C"	vec3_t	vpn, base_vpn;
...
extern void R_DrawSkyBox(int currentkey);
extern void R_DrawSkyChain(msurface_t* s);
extern void AllowFog(int allowed);
