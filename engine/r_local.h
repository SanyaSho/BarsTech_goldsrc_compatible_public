...
extern cvar_t r_ambient_r, r_ambient_g, r_ambient_b;
...
void R_RenderBmodelFaceReverse(model_t* model, msurface_t* watersurf);
...
extern mvertex_t* pbverts;
extern bedge_t* pbedges;
extern int			numbverts, numbedges;

void R_BeginEdgeFrame (void);
void R_ScanEdges (void);
void D_DrawSurfaces (void);
EXTERN_C void R_InsertNewEdges (edge_t *edgestoadd, edge_t *edgelist);
EXTERN_C void R_StepActiveU (edge_t *pedge);
EXTERN_C void R_RemoveEdges (edge_t *pedge);
...
extern finalvert_t finalverts[MAXSTUDIOVERTS];
extern float *plightvalues;
...
extern float filterColorRed, filterColorGreen, filterColorBlue, filterBrightness;
extern int filterMode;
extern cvar_t r_lightmap, r_lightstyle;
extern cvar_t r_mmx;
extern cvar_t r_traceglow;

extern spritedesc_t			r_spritedesc;

extern unsigned char r_lut[0xffff + 1];
...
EXTERN_C void R_ClipEdge (mvertex_t *pv0, mvertex_t *pv1, clipplane_t *clip);
