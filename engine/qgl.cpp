...
#ifdef WIN32
// TODO: GoldSrc references Glide, but it's an ancient unsupported API, so there is little point in reverse engineering it
...
// TODO: need to get rid of this and use GLEW
...
** might be.
*/
HINSTANCE QGL_Init( const char* pdllname, const char* pszCmdLine )
{
	// OpenGL is loaded by SDL
	...
	return (HINSTANCE)glw_state.hinstOpenGL;
}
...
void GLimp_EnableLogging( void )
{
	if( !glw_state.log_fp )
	{
		...
		snprintf( buffer, Q_ARRAYSIZE( buffer ), "/gl.log" );
