...
struct saverestore_s
{
	...
	char		*pCurrentData;	// Current rgba pointer for sequential access
...
#define _FIELD(type,name,fieldtype,count,flags)		{ fieldtype, (char*)#name, offsetof(type, name), count, flags }
