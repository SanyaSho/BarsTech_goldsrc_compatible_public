...
void R_DrawSprite(void)
{
	...
	r_spritedesc.pspriteframe = R_GetSpriteFrame(psprite, currententity->curstate.frame);

	if (currententity->curstate.scale > 0.0)
		r_spritedesc.scale = currententity->curstate.scale;
	else
