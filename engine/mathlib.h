...
#define VectorAvg(a,b,c) {(c)[0]=((a)[0]+(b)[0])/2;(a)[1]=((a)[1]+(b)[1])/2;(a)[2]=((a)[2]+(b)[2])/2;}
...
extern void MaskExceptions();
extern void Sys_LowFPPrecision();
extern void Sys_HighFPPrecision();
extern void Sys_PushFPCW_SetHigh();
extern void Sys_PopFPCW();
extern void Sys_SetFPCW();
extern void Sys_TruncateFPU();
