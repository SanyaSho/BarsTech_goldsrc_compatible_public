...
enum
{
	MAX_BUFFER_SIZE = 999999,	// maximum size of text rgba
	DRAW_OFFSET_X =	3,
	DRAW_OFFSET_Y =	1,
};
...
void RichText::InsertChar(wchar_t ch)
{
	...
	// insert the new char at the end of the rgba
...
//-----------------------------------------------------------------------------
// Purpose: Insertsa a unicode string into the rgba
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Purpose: gets text from the rgba
//-----------------------------------------------------------------------------
