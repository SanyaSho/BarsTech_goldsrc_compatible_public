...
class BlockGroup : public BlockEntry {
 ...
 public:
  ...
  long long GetPrevTimeCode() const;  // relative to block's m_flTime
...
class Cluster {
 ...
 public:
  ...
  long long GetFirstTime() const;  // m_flTime (ns) of first (earliest) block
  long long GetLastTime() const;  // m_flTime (ns) of last (latest) block
